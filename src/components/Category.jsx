...
function Category() {
    ...
    return (
        <>
            <label htmlFor="category-input" className="hidden open-cate"><i className="fas fa-plus-circle"></i></label>
            < input id="category-input" type="checkbox" hidden className="hidden" ></input>
            <section className="category scroll ltr">
                <label htmlFor="category-input" className="hidden close-cate"><i className="fas fa-window-close"></i></label>
